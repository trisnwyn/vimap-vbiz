...
<body>
  ...
  <div class="disclaimer">
    <strong>Disclaimer:</strong> This report is generated by VinMap using province statistics calibrated from
    Global Forest Watch Hansen/UMD aggregate tree-cover-change data. Values should not be used as sole evidence for
